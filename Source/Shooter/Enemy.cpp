...
void AEnemy::Die()
{
	...
	// Increment PlayerKillCount using the ShooterCharacter reference
	if (ShooterCharacter)
	{
		ShooterCharacter->PlayerKillCount += 1;

		// Check if PlayerKillCount reaches 10
		if (ShooterCharacter->PlayerKillCount == 10)
		{
		//	ShooterCharacter->SpawnGruxHalloween();
		}
	}
