...
public:
	...
	void PlayEquipSound(bool bForcePlaySound = false); // when given value in .h files, can be omitted in other places, default value = false
...
private:
	...
	UPROPERTY(VisibleAnywhere, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	float FernelExponent;

	UPROPERTY(VisibleAnywhere, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	float FernelReflectFraction;
...
public:
	...
	// Set ammo icon for the pickup widge
